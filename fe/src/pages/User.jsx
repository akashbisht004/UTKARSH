...
import { User, Calendar, MessageSquare, LogOut, ChevronLeft, ChevronRight, MapPin, Loader2, Video, BarChart } from 'lucide-react';
...
function UserPage() {
  ...
  const menuItems = [
    ...
    { icon: BarChart, label: 'Report Analysis', path: '/user/report-analysis' }
  ];
