...
function Header() {
  ...
  return (
    <header className="bg-white/80 backdrop-blur fixed top-0 left-0 w-full shadow-sm z-50">
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center">
            ...
            <nav className="hidden md:ml-6 md:flex md:space-x-8">
              <Link to="/" className="text-gray-600 hover:text-blue-600 px-3 py-2 rounded-md">Home</Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link to="/" className="block px-3 py-2 text-gray-600 hover:text-blue-600 rounded-md">Home</Link>
